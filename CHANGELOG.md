...
- Update simulator version in CI
  - Contributed by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#94](https://github.com/space-code/log/pull/94).
- Update `ci.yml`
...
### Miscellaneous Tasks
- Fix typo in the CODEOWNERS file name
  - Contributed by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#43](https://github.com/space-code/log/pull/43).
- Remove hooks
